    ...
    <div class="gh-content">
        <div class="gh-avatar">
            <a href="${user.html_url} target="_blank">
                ...
                width="80" height="80" alt="${user.login}" />
                </a> 
        </div>
...
function fetchGitHubInformation(event) {
    /* Clears Repo List when Input Field is emptied */
    $("#gh-user-data").html("");
    $("#gh-repo-data").html("");
    ...
    $.when(
        ...
        function (errorResponse) {
            if (errorResponse.status === 404) {
                ...
                $("#gh-user-data").html(`<h4>Too many requests, please wait
                until ${resetTime.toLocaleDateString()} before trying again</h4>`)
            } else {
